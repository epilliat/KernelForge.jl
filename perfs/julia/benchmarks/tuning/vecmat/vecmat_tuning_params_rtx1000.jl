...
vecmat_params = Dict(
    Float32 => Dict(
        10^8 => Dict(
            ...
            (10^1, 10^7) => (Nitem=1, Nthreads=4, workgroup=256, blocks=128),
            (10^2, 10^6) => (Nitem=2, Nthreads=16, workgroup=256, blocks=128),
            (10^3, 10^5) => (Nitem=8, Nthreads=16, workgroup=256, blocks=128),
            (10^4, 10^4) => (Nitem=8, Nthreads=256, workgroup=256, blocks=128),
            (10^5, 10^3) => (Nitem=8, Nthreads=128 * 256, workgroup=256, blocks=128),
            (10^6, 10^2) => (Nitem=8, Nthreads=128 * 256, workgroup=256, blocks=128),
            (10^7, 10^1) => (Nitem=8, Nthreads=128 * 256, workgroup=256, blocks=128),
            (10^8, 10^0) => (Nitem=8, Nthreads=128 * 256, workgroup=256, blocks=128),
        ),
        10^7 => Dict(
            ...
            (10^4, 10^3) => (Nitem=8, Nthreads=512, workgroup=256, blocks=128),
            (10^5, 10^2) => (Nitem=8, Nthreads=512, workgroup=256, blocks=128),
...
quick_profile(10^8, KF.VecMat, T=Float32, ms=0.01, def=false, tuned=true, AT=CuArray, arch=KF.RTX1000())