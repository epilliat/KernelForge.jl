...
matvec_params = Dict(
    Float32 => Dict(
        10^8 => Dict(
            ...
            (10^4, 10^4) => (Nitem=4, chunksz=16, Nblocks=4, workgroup=512),
        ...
        10^7 => Dict(
            (10^4, 10^3) => (Nitem=4, chunksz=8, Nblocks=1, workgroup=256),
...
quick_profile_simple_roc(10^8, KF.MatVec, T=Float32, ms=10, def=true, tuned=true, AT=ROCArray)